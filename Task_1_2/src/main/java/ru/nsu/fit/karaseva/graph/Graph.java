...
public class Graph {
  ...
  /**
   * Graph implementation method. If null is passed as a parameter "arr" to the method, then the
   * graph simply will not contain any edges. If null passed as an element of the array of edges of
   * the graph, then this edge will not be included in graph.
   *
  ...
  /**
   * This method returns array of 2 where 1st element is number of next vertex and 2nd is distance
   * to this vertex.
   *
   * @param v                 vertex
   * @param numberOfNeighbors number of neighbor of vertex v
   * @return array of two elements, first is number of the next vertex and second is distance to
   * that vertex.
   */
